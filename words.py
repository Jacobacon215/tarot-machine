...
magic_words = {'experiment', 'trans', 'initiative', 'action',
               'proactive', 'willpower', 'block', 'job', 'career'}
hp_words = {'intuition', 'stuck', 'midterms',
            'exams', 'friendship', 'relationship', 'friend'}
empress_words = {'project', 'idea', 'block', 'mpreg', 'health',
                 'inspiration', 'nature', 'intuition', 'job', 'career'}
...
tower_words = {'midterm', 'exam', 'exams', 'grades', 'grade', 'partner',
               ...
               'terror'}
star_words = {'therapy', 'ex', 'again', 'another',
              'fresh start', 'faith', 'new', 'try', 'red', 'flag', 'year'}
...
tarot_cards = ["fool", "magician", "highpriestess", "empress", "emperor", "hierophant", "lovers", "chariot", "strength", "hermit", "wheeloffortune", "justice", "hangedman", "death",
...
def find_cards(in_str):
    question_asked = in_str
    ...
    selected = sorted(
        card_score_dict, key=card_score_dict.get, reverse=True)[0:3]
    if "tower" not in selected:
        tower_chance = random.random()
        if tower_chance > 0.95:
            tower = True
        if tower:
...
def give_answers(cards):
    card_def = {'fool': 'leap of faith, step into the unknown', 'magician': 'the tools are in front of you, you should act', 'highpriestess': 'hidden wisdom covered by overthinking',
                ...
                'hermit': 'retreat to reflect, inner wisdom', 'wheeloffortune': 'change is the only constant. life has ups and downs', 'justice': 'balance the scales, truth will prevail',
...
def pick_reading(cards):
    adjectives = {'fool': 'new', 'magician': 'capable', 'highpriestess': 'wise', 'empress': 'creative', 'emperor': 'authoritative', 'hierophant': 'traditional',
                  'lovers': 'emotional', 'chariot': 'purposeful', 'strength': 'gentle', 'hermit': 'introspective', 'wheeloffortune': 'cyclical', 'justice': 'balanced',
    ...
    nouns = {'fool': 'step forward', 'magician': 'option', 'highpriestess': 'wisdom', 'empress': 'creation', 'emperor': 'boundary', 'hierophant': 'rules',
             'lovers': 'heart', 'chariot': 'purpose', 'strength': 'tenderness', 'hermit': 'self', 'wheeloffortune': 'change', 'justice': 'truth',
    ...
    verbs = {'fool': 'leap', 'magician': 'act', 'highpriestess': 'realize', 'empress': 'nurture', 'emperor': 'control', 'hierophant': 'follow',
             'lovers': 'feel', 'chariot': 'proceed', 'strength': 'guide', 'hermit': 'reflect', 'wheeloffortune': 'rotate', 'justice': 'balance',
    ...
    reading1 = f"the {noun} holding you back makes you {
        adjective} so you should {verb}"
    reading2 = f"trust the {adjective} {noun} that will {verb} you"
    reading3 = f"you are {adjective} so you should {verb} the {noun}"
    reading4 = f"if you {verb} the {
        noun} you might find that you are {adjective}"
