...
tarot_cards = ["fool", "magic", "highpriestess", "empress", "emperor", "hierophant", "lovers", "chariot", "strength", "hermit", "wheel of fortune", "justice", "hangedman", "death",
...
def give_answers(cards):
    card_def={'fool':'leap of faith, step into the unknown', 'magician':'the tools are in front of you, you should act', 'highpriestess':'hidden widsom covered by overthinking',
